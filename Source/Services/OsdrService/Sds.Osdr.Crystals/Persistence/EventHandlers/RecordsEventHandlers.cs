...
namespace Sds.Osdr.Crystals.Persistence.EventHandlers
{
    public class RecordsEventHandlers : IConsumer<CrystalCreated>
    {
        ...
        public async Task Consume(ConsumeContext<CrystalCreated> context)
        {
