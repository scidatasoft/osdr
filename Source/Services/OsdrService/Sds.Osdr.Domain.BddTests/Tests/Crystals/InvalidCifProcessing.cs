...
namespace Sds.Osdr.BddTests
{
    ...
    public class InvalidCifProcessing : OsdrTest
    {
        ...
        {
            FileId = ProcessRecordsFile(JohnId.ToString(), "1100110_modified.cif", new Dictionary<string, object>() { { "parentId", JohnId } }).Result;
        }
