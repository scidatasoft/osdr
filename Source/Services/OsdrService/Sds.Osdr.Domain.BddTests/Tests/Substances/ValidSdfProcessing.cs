...
namespace Sds.Osdr.BddTests
{
    ...
    public class ValidSdfProcessing : OsdrTest
    {
        ...
        {
            FileId = ProcessRecordsFile(JohnId.ToString(), "drugbank_10_records.sdf", new Dictionary<string, object>() { { "parentId", JohnId } }).Result;
        }
