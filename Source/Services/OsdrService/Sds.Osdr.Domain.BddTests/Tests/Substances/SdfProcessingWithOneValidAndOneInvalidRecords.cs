...
namespace Sds.Osdr.BddTests
{
    ...
    public class SdfProcessingWithOneValidAndOneInvalidRecords : OsdrTest
    {
        ...
        {
            FileId = ProcessRecordsFile(JohnId.ToString(), "test_solubility.sdf", new Dictionary<string, object>() { { "parentId", JohnId } }).Result;
        }
