...
namespace Sds.Osdr.BddTests
{
    ...
    public class InvalidMolProcessing : OsdrTest
    {
        ...
        {
            FileId = ProcessRecordsFile(JohnId.ToString(), "ringcount_0.mol", new Dictionary<string, object>() { { "parentId", JohnId } }).Result;
        }
