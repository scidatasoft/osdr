...
namespace Sds.Osdr.Images.Modules
{
    public class ImageModule : IModule
    {
        ...
        public ImageModule(ISession session, IBusControl bus)
        {
        ...
        {
            return (new string[] { ".jpg", ".jpeg", ".png", ".bmp", ".gif" }).Contains(Path.GetExtension(blob.BlobInfo.FileName).ToLower());
        }
        ...
        public async Task Process(BlobLoaded blob)
        {
            ...
            var file = new ImageFile(fileId, userId, parentId, blobInfo.FileName, FileStatus.Loaded, blobInfo.Bucket, blobInfo.Id, blobInfo.Length, blobInfo.MD5);
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services.AddTransient<IModule, ImageModule>();
        ...
        {
            services.AddScoped<IModule, ImageModule>();
        }
