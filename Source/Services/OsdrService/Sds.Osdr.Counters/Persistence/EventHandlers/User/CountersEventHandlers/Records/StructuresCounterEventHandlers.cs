...
{
    public class StructuresCounterEventHandlers : IConsumer<ChemicalFileProcessed>
    {
        ...
        public StructuresCounterEventHandlers(IMongoDatabase database)
        {
            _database = database ?? throw new ArgumentNullException(nameof(database));
        }

        
        public async Task Consume(ConsumeContext<ChemicalFileProcessed> context)
        {
            ...
            update = Builders<BsonDocument>.Update
                    .Inc("Counters.Structures", context.Message.ProcessedRecords + context.Message.FailedRecords);
